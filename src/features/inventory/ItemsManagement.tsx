        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <select
              ...
              className="px-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-lg text-slate-800 font-medium focus:border-[#FF6B00] focus:ring-1 focus:ring-[#FF6B00] outline-none w-full sm:w-auto"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 font-mono focus:border-[#FF6B00] focus:ring-1 focus:ring-[#FF6B00] outline-none"
                    required
                  />
                </div>
              ...
              <div className="pt-3 border-t border-slate-100 flex justify-end gap-2">
                ...
                <button
                  id="save-item-btn"
                  type="submit"
                  className="px-4 py-2 bg-[#FF6B00] hover:bg-[#E56000] text-white font-semibold rounded-lg shadow-xs transition cursor-pointer"
                >
