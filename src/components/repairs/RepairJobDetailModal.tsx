...
export const RepairJobDetailModal: React.FC<RepairJobDetailModalProps> = ({
  ...
  // Confirmation Modals State (Step 6)
  ...
  const [isStatusHistoryOpen, setIsStatusHistoryOpen] = useState(true);
  ...
  // 4. Complete Job Action (In Progress -> Completed) with confirmation
  ...
  const executeCompleteJob = () => {
    ...
    showToast('Job marked as Completed! Customer notified that vehicle is ready.');
  };
  ...
  // 6. Mark as Delivered Action with confirmation
  ...
  const executeMarkAsDelivered = () => {
    ...
    showToast('Vehicle marked as Delivered! Thank you for choosing Apex Garage.');
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white border border-slate-200 rounded-2xl shadow-xl max-w-3xl w-full my-6 overflow-hidden text-slate-900">
        ...
        <div className="p-5 space-y-5 max-h-[65vh] overflow-y-auto">
          ...
          {/* 5-STAGE REPAIR PROGRESS STEPPER */}
                  ...
                  <div key={stg.key} className="flex flex-col items-center text-center">
                    <div
                      className={`w-7 h-7 rounded-full flex items-center justify-center font-bold text-xs mb-1.5 transition-all ${
                        isCurrent
                          ? 'bg-[#FF6B00] text-white ring-3 ring-[#FFF1E8]'
                          : isPassed
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-slate-900">
                  Status History ({job.statusHistory?.length || 1})
                </span>
              </div>
              {isStatusHistoryOpen ? (
              ...
              <div className="p-4 space-y-3">
                {job.statusHistory && job.statusHistory.length > 0 ? (
                  <div className="space-y-2.5">
                    {job.statusHistory.map((hist, idx) => {
                      const formatStatus = (s?: string) =>
                        s ? s.replace(/_/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase()) : 'Created';
                        ...
                        >
                          <div className="space-y-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              <span className="font-semibold text-slate-700">
                                {formatStatus(hist.fromStatus)}
                              </span>
                              <ArrowRight className="w-3 h-3 text-slate-400" />
                              <span className="font-bold text-slate-900 bg-white px-2 py-0.5 rounded border border-slate-200">
                                {formatStatus(hist.toStatus)}
                              </span>
                            </div>
                            {hist.note && (
                          ...
                          <div className="text-right shrink-0 text-[11px] text-slate-500">
                            <div className="font-semibold text-slate-800">
                              Changed by: {hist.changedBy || 'Staff'}
                            </div>
                  ...
                  <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-500 italic text-center">
                    Initial intake record created for Order #{job.jobNumber}.
                  </div>
                )}
              </div>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden">
            <div className="p-5 bg-slate-900 text-white flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm">Mark Repair as Completed?</h3>
              </div>
              <button
            ...
            <div className="p-5 space-y-4 text-xs">
              <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                <div className="flex justify-between">
                  <span className="text-slate-500 font-medium">Repair Order:</span>
              ...
              <p className="text-slate-600 leading-relaxed">
                This will record the repair completion and notify the customer that their vehicle is ready for pickup and invoice payment.
              </p>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                ...
                <button
                  type="button"
                  id="confirm-complete-job-btn"
                  onClick={executeCompleteJob}
                  className="px-4 py-2 text-xs font-bold text-white bg-[#FF6B00] hover:bg-[#E56000] rounded-lg shadow-xs transition flex items-center gap-1.5 cursor-pointer"
                >
                  <CheckCircle2 className="w-4 h-4 text-white" />
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden">
            <div className="p-5 bg-slate-900 text-white flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm">Confirm Vehicle Delivery?</h3>
              </div>
              <button
            ...
            <div className="p-5 space-y-4 text-xs">
              ...
              <p className="text-slate-600 leading-relaxed">
                This will mark the vehicle as delivered and conclude the repair order workflow.
              </p>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                ...
                <button
                  type="button"
                  id="confirm-deliver-job-btn"
                  onClick={executeMarkAsDelivered}
                  className="px-4 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg shadow-xs transition flex items-center gap-1.5 cursor-pointer"
                >
